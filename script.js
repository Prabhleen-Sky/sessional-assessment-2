...
// const urlImg = `https://serpapi.com/search.json?key=c9bab9f44fe6b84ac9a2f909757833c472ce06a69fb5981d2ad6b8c036bbcc72&q=blogging&tbm=isch&ijn=0`;
...
xhr.onreadystatechange = () => {
     if(xhr.status === 200 && xhr.readyState === 4){
          ...
          for(let i=0; i<response.length;i++){
              template += `
              <div class="blog-card">
                <img src="assests/headerbg.jpg" class="blog-image" alt="">
